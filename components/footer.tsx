...
export function Footer() {
  return <footer className="footer"><div className="container">
    <div className="footer-grid">
      ...
      <div><h3>Plan your purchase</h3><div className="footer-links"><Link href="/calculator">Mortgage calculator</Link><Link href="/checklist">Buying checklist</Link><Link href="/documents">Document explainer</Link><Link href="/broker-introduction">Broker introduction</Link><Link href="/valuation-report">Paid report</Link></div></div>
